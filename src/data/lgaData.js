export const LGA_WARDS = {
  ...
  'Orumba North': [
    ...
    'Nanka I', 'Nanka II', 'Ndikelionwu', 'Ndiokolo/Ndiokpaleke', 'Ndiowu',
    'Oko I', 'Oko II', 'Omogho', 'Ufuma I', 'Ufuma II', 'Ndiokpaleze',
    'Amaokpala', 'Omogho',
  ],
  'Orumba South': [
    'Agbudu', 'Akpu', 'Ezira', 'Eziagu', 'Isulo', 'Nawfija', 'Ogboji',
    'Ihitte', 'Owerre Ezukala 1', 'Owerre Ezukala 2', 'Ogbunka 1', 'Ogbunka 2',
    'Umuchukwu', 'Umunze 1', 'Umunze 2', 'Umunze 3', 'Umuomaku', 'Onneh/Enugwu Umuonyia',
  ],
}

export const LGAS = Object.keys(LGA_WARDS)
